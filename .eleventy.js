...
module.exports = function(config) {
    ...
    config.addShortcode("footer", function() {
        ...
        <p id="line1"><a href="/admin/approveletters" style="text-decoration: none;"><i class="ph ph-key-bold"></i></a> <u> 2023 </u><i class="ph ph-copyright"></i> <a href="https://twitter.com/oxmasterlist">OXMasterlist</a>
