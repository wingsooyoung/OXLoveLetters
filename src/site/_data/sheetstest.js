...
module.exports = async function() {
    try {
        const googleSheetUrl = `https://sheets.googleapis.com/v4/spreadsheets/1e4JKidqlL1JLYf_xQM8OSTSxrtNkHy7AR4AJKCkpEtM/values/Sheet1?alt=json&key=AIzaSyBOQeuna4PK-WCldGMOwOuAm9dHBpUoLlI`;

        /* This returns a promise */
        return EleventyFetch(googleSheetUrl, {
